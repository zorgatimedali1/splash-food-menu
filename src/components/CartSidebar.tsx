        ...
        >
          ...
          {items.length === 0 && (
            <div className="flex-1 flex flex-col items-center justify-center px-6">
              <div className="w-20 h-20 rounded-full bg-splash-light-gray flex items-center justify-center mb-5">
              ...
              <Link
                to="/menu"
                onClick={closeCart}
                className="inline-flex items-center gap-2 px-6 py-3 bg-black text-white text-sm font-montserrat font-bold rounded-xl hover:bg-black/80 transition-all duration-300"
              >
            ...
            <>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <button
                            ...
                            className="flex items-center justify-center w-7 h-7 rounded-lg border border-splash-border text-black hover:bg-splash-light-gray transition-colors"
              ...
              <div className="border-t border-splash-border px-6 py-5 space-y-3 bg-white">
                ...
                <div className="pt-2 space-y-3">
                  {/* Address */}
                  <div>
                    <label className="font-montserrat text-xs font-bold text-black uppercase tracking-wider block mb-1.5">
                  ...
                  <Link
                    to="/menu"
                    onClick={closeCart}
                    className="w-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl border-2 border-black text-black font-montserrat font-bold text-sm hover:bg-black hover:text-white transition-all duration-300"
                  >
