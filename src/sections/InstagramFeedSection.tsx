      ...
      <div className="section-container">
        ...
        <div className="flex justify-center gap-6">
          <a
            ...
            className="w-28 h-28 sm:w-36 sm:h-36 md:w-44 md:h-44 lg:w-48 lg:h-48 rounded-2xl border border-splash-border flex items-center justify-center text-black hover:bg-gray-950 hover:text-white hover:border-gray-950 transition-all duration-300"
          >
